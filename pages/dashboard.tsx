...
export default function Dashboard() {
  return (
    <div className="w-full flex flex-col min-h-screen items-center justify-center pt-40">
      <div className="max-w-8xl w-full px-4 sm:px-6 lg:px-8">
        <div className="py-6">
          <div className="flex flex-col md:flex-row gap-6">
            <div className="md:flex-1 bg-orange-100 rounded-lg shadow-lg p-6 w-full">
